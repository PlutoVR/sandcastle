...
export class Boid
{
    ...
    {
        const spG = new Group();
        const sp = new Mesh(new SphereBufferGeometry(5, 20, 20), new MeshNormalMaterial({ wireframe: true }));
        spG.add(sp);
        this.mesh = spG;
    }
    ...
    {
        const bxG = new Group();
        const bx = new Mesh(new BoxBufferGeometry(5, 5, 5), new MeshNormalMaterial({ wireframe: true }));
        bxG.add(bx);
        this.mesh = bxG;
    }
