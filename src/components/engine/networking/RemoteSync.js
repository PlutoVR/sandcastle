...
class RemoteSync 
{
	...
	addRemoteObject(destId, objectId, object)
	{
		...
		if (objects === undefined)
		{
			...
			console.warn('RemoteSync.addRemoteObject: has not received any add object request from ' + destId + ' peer.');
			return;
		...
		if (info === undefined)
		{
			...
			console.warn('RemoteSync.addRemoteObject: has not received ' + objectId + ' object addition request from ' + destId + ' peer.');
			return;
