...
var VRButton = {
    ...
    createButton: function (renderer, options)
    {
        ...
        function onInputSourcesChange(event)
        {
            ...
            state.eventHandler.dispatchEvent('inputsourceschanged', event);
            // state.xrInputSources = event.session.inputSources;
            // console.log(event.session);
        }

        const update_state = (gamepad) =>
        {
            ...
            {
                console.log(gamepad.buttonBoxes[ i ].pressed);
                console.log(gamepad.buttonBoxes[ i ].value);
                console.log(gamepad.buttonBoxes[ i ].touched);
            }
        ...
        function showEnterVR( /*device*/)
        {
            ...
            function onSessionStarted(session)
            {
                ...
                session.addEventListener('oninputsourceschange', onInputSourcesChange);
